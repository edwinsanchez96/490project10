...
require_once('/home/edwin/Documents/490/490project10/path.inc');
require_once('/home/edwin/Documents/490/490project10/get_host_info.inc');
require_once('/home/edwin/Documents/490/490project10/rabbitMQLib.inc');
...
function doRollback ($type,$package,$tier,$packageName,$version,$rollbackVersion,$ipAddress){
	...
	#destination of the tar to send
        $file = "/home/edwin/Documents/490/490project10/deploy/backup/" . $packageName . "-" . $rollbackVersion . ".tgz";
...
function doDeploy ($type,$package,$tier,$packageName,$version,$ipAddress){
	...
	#destination of the tar to send
	$sourcefile = "/home/edwin/Documents/490/490project10/deploy/scp/" . $packageName . "-" . $version . ".tgz";
...
function doBundle ($type,$package,$tier,$packageName,$version){
	...
	$query = mysqli_query($mydb, "INSERT INTO Builds VALUES(NULL,'$packageName','$version')");
